export function render() {
    return `
        <h1 class="page-title">ROOM DEATILS</h1>
        ${String.raw`
        <div class="info-card">
            <h3>Information Regarding ROOM DEATILS</h3>
            <p>This module provides relevant information and policies regarding ROOM DEATILS. Currently, there are no pending actions required from your side.</p>
        </div>
