export function render() {
    return `
        <h1 class="page-title">SAP PROCESS</h1>
        ${String.raw`
        <div class="info-card">
            <h3>Information Regarding SAP PROCESS</h3>
            <p>This module provides relevant information and policies regarding SAP PROCESS. Currently, there are no pending actions required from your side.</p>
        </div>
