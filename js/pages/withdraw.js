export function render() {
    return `
        ...
        ${String.raw`
        <div class="info-card">
            <h3>Information Regarding WITHDRAW</h3>
            <p>This module provides relevant information and policies regarding WITHDRAW. Currently, there are no pending actions required from your side.</p>
        </div>
